    ...
    async.mapLimit(queue_list, 3, function (queue_obj, cb) {
        ...
        var options = {
            ...
            headers: {
                ...
                'Cookie': 'PHPSESSID=ligglj5dg2nt7h6p75m76aj8s2; homepage=1; Hm_lvt_0cb325d7c4fd9303b6185c4f6cf36e36=1463982373; Hm_lpvt_0cb325d7c4fd9303b6185c4f6cf36e36=1463982373; gr_user_id=4ea21246-7bb1-4222-8371-5b14a0a951cb; gr_session_id_bbbf4f3982c24d55=2c7d2c6b-7c92-4995-9221-dd037a249e7f',
            },
            method: 'GET',
            gzip: true,
            jar: true,
        ...
        try {
            request(options, function (error, response, body) {
                ...
                if (!error && response.statusCode == 200) {
                    ...
                    console.error('----抓取错误--------');
                    console.error(error);
                    db.set_spider_queue_result_error(url, error);
                }
